namespace Terraria.ModLoader
{
	public struct DamageModifier
	{
		...
		public DamageModifier(float additive, float multiplicative) {
		...
		// use operator & for combine, because + and * are both slightly misleading
		// specifically, when combining modifiers, the order of operation of + and * with floats is ignored
		...
		public static explicit operator int(DamageModifier m) =>
			(int)((float)m + 5E-06);
